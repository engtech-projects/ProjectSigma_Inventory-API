...
class RequestNcpoDetailedResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            'id' => $this->id,
            'date' => $this->toReadableDateAttribute($this->date),
            'ncpo_no' => $this->ncpo_no,
            'po_number' => $this->purchaseOrder?->po_number,
            'po_date' => $this->toReadableDateAttribute($this->purchaseOrder->transaction_date),
            ...
            'total' => number_format($this->purchaseOrder->requestCanvassSummary->grand_total_amount, 2),
