...
class RequestCanvassSummaryDetailedResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            'id' => $this->id,
            'project_code' => $this->whenLoaded(
                'priceQuotation',
                fn () => $this->priceQuotation->requestProcurement->requisitionSlip?->project_department_name
            ),
            'reference_number' => $this->whenLoaded(
                'priceQuotation',
                fn () => $this->priceQuotation->requestProcurement->requisitionSlip?->reference_no
            ),
